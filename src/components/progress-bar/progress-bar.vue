...
export default {
    ...
    methods: {
        draw() {
            ...
            const radius = 60;
            const redArcStartAngle = this.calculateProgressBar.redArc.startAngle;
            const redArcEndAngle = this.calculateProgressBar.redArc.endAngle;
            const greenArcStartAngle = this.calculateProgressBar.greenArc.startAngle;
            const greenArcEndAngle = this.calculateProgressBar.greenArc.endAngle;
            const percentage = this.calculateProgressBar.percentageDone;
